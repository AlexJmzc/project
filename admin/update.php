...
if(isset($_POST['submit'])){
   ...
   if($old_pass != $empty_pass){
      if($old_pass != $prev_pass){
         $message[] = 'Anterior contraseña no coincide';
   ...
   <form class="register" action="" method="post" enctype="multipart/form-data">
      ...
      <div class="flex">
         ...
         <div class="col">
            ...
            <input type="password" name="old_pass" placeholder="Ingrese la contraseña actual" maxlength="20"  class="box">
            <p>Nueva contraseña :</p>
            <input type="password" name="new_pass" placeholder="Ingrese la nueva contraseña" maxlength="20"  class="box">
            <p>Confirmar contraseña :</p>
            <input type="password" name="cpass" placeholder="Confirmar la nueva contraseña" maxlength="20"  class="box">
         </div>
      </div>
