...
<section class="view-content">
   ...
   <?php
      ...
      echo '<p class="empty">No se encontró contenido <a href="add_content.php" class="btn" style="margin-top: 1.5rem;">add videos</a></p>';
   }
   ...
   <div class="show-comments">
      ...
      <div class="box">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <button type="submit" name="delete_comment" class="inline-delete-btn" onclick="return confirm('¿Eliminar comentario?');">delete comment</button>
         </form>
      </div>
      <?php
       }
