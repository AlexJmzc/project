   ...
   <div class="row">
      ...
      <div class="details">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <input type="submit" value="Eliminar playlist" class="delete-btn" onclick="return confirm('¿Eliminar playlist?');" name="delete">
         </form>
      </div>
   </div>
   <?php
         ...
         echo '<p class="empty">No hay playlists</p>';
      }
   ?>
...
<section class="contents">
   ...
   ?>
      <div class="box">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <input type="submit" value="Eliminar" class="delete-btn" onclick="return confirm('¿Eliminar video?');" name="delete_video">
         </form>
   ...
   <?php
         ...
         echo '<p class="empty">No hay videos <a href="add_content.php" class="btn" style="margin-top: 1.5rem;">add videos</a></p>';
      }
   ?>
